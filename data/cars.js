...
export const CARS = [
  ...
  // ── Changan PK + JDM kei imports + Sonata DN8 ──
  {id:"oshan_x7",       name:"Changan Oshan X7",      year:"2021+",   market:"PK · New",     cat:"Mid SUV",           rearType:"multilink",      rearLabel:"Multilink Rear",                sidewall:124,rimSize:19,wheelbase:2786,weight:1551,tire:"225/55 R19",springTuning:"comfort", platformAge:"new", bodyType:"monocoque",hasCtb:false,hasRearSubframe:true, hcImpact:"low"},
  {id:"alsvin",         name:"Changan Alsvin",        year:"2021+",   market:"PK · New",     cat:"Sedan",             rearType:"torsion_beam",   rearLabel:"Torsion Beam Rear",             sidewall:102,rimSize:15,wheelbase:2535,weight:1120,tire:"185/55 R15",springTuning:"standard",platformAge:"new", bodyType:"monocoque",hasCtb:false,hasRearSubframe:false,hcImpact:"mid"},
  {id:"yaris_cross_jdm",name:"Toyota Yaris Cross Hybrid AWD-i", year:"2020+", market:"Japan Import", cat:"Compact SUV", rearType:"double_wishbone",rearLabel:"Double Wishbone (AWD-i)",       sidewall:133,rimSize:16,wheelbase:2560,weight:1290,tire:"205/65 R16",springTuning:"standard",platformAge:"new", bodyType:"monocoque",hasCtb:false,hasRearSubframe:true, hcImpact:"low"},
  {id:"n_one_jg1",      name:"Honda N-One (JG1/JG2)", year:"2012–20", market:"Japan Import", cat:"Hatchback",         rearType:"torsion_beam",   rearLabel:"Torsion Beam Rear",             sidewall:101,rimSize:14,wheelbase:2520,weight:850, tire:"155/65 R14",springTuning:"standard",platformAge:"old", bodyType:"monocoque",hasCtb:false,hasRearSubframe:false,hcImpact:"mid"},
  {id:"n_one_jg3",      name:"Honda N-One (JG3/JG4)", year:"2020+",   market:"Japan Import", cat:"Hatchback",         rearType:"torsion_beam",   rearLabel:"Torsion Beam Rear",             sidewall:101,rimSize:14,wheelbase:2520,weight:860, tire:"155/65 R14",springTuning:"standard",platformAge:"new", bodyType:"monocoque",hasCtb:false,hasRearSubframe:false,hcImpact:"mid"},
  {id:"sonata_dn8",     name:"Hyundai Sonata (DN8)",  year:"2021+",   market:"PK · New",     cat:"Sedan",             rearType:"multilink",      rearLabel:"Multilink Rear",                sidewall:106,rimSize:18,wheelbase:2840,weight:1500,tire:"235/45 R18",springTuning:"comfort", platformAge:"new", bodyType:"monocoque",hasCtb:false,hasRearSubframe:true, hcImpact:"low"},
  {id:"sonata_dn8_nline",name:"Hyundai Sonata N Line (DN8)", year:"2025+", market:"PK · New", cat:"Sedan",             rearType:"multilink",      rearLabel:"Multilink + Sport Tune",        sidewall:98, rimSize:19,wheelbase:2840,weight:1675,tire:"245/40 R19",springTuning:"stiff",   platformAge:"new", bodyType:"monocoque",hasCtb:false,hasRearSubframe:true, hcImpact:"low"},
];
...
export const ARTICLES = [
  {
    ...
    category:"DEEP DIVE",
    readTime:"6 min read",
    summary:"A PKR 150 lakh truck and a PKR 32 lakh hatchback arrive at nearly the same comfort score. Here's what that number hides — and why it matters more than the score itself.",
    cars:["Fortuner","Alto (PK)"],
    content:[
      {type:"lead",text:"The Toyota Fortuner costs up to PKR 165 lakh. The Suzuki Alto costs PKR 32 lakh. Their CarComfortScore composite numbers — {{crcs:fortuner}} and {{crcs:alto_pk}} — sit within a handful of points of each other. If you stopped reading there, you'd conclude they ride about the same. You'd be wrong in a way that matters for your health."},
      {type:"h2",text:"The numbers that match"},
      {type:"p",text:"Fortuner CRCS: {{crcs:fortuner}}. Alto (PK) CRCS: {{crcs:alto_pk}}. The composite scores are nearly identical. At a glance, this suggests both cars deliver a similar ride quality experience on Pakistani roads. That conclusion is technically correct and practically misleading at the same time."},
      {type:"h2",text:"Where the Fortuner's score comes from"},
      {type:"p",text:"The Fortuner scores {{impact:fortuner}}/100 on Impact Isolation. That number is propped up by one thing: its enormous 265/65 R17 tyres with 172mm of sidewall. That's nearly 17 centimetres of rubber between the road and the rim. On a sharp stone strike, that tyre cushions the initial impact better than almost any car in the Pakistani market. Without those tall tyres, the Fortuner's truck-spec springs would give up most of that advantage."},
      ...
      {type:"p",text:"The Alto scores {{impact:alto_pk}}/100 on Impact Isolation. Its torsion beam rear suspension isn't as physically violent as the Fortuner's solid axle — it doesn't produce that sudden lateral jolt. But at 660kg with stiffened springs, every impact is transmitted quickly and sharply. The car is too light and too stiff to absorb anything."},
      {type:"p",text:"Here's the asymmetry: the Alto pays no Whole-Body Vibration (WBV) penalty in CRCS, while the Fortuner loses 10 points for producing the truck-character vibration ISO 2631-1 flags as a lumbar health risk. That penalty is what brings the two composite scores so close together despite the Fortuner's better raw absorption."},
      ...
      {type:"p",text:"When two cars have similar composite scores, the breakdown matters more than the total. The Alto's {{impact:alto_pk}}/100 on Impact Isolation is among the lower scores in this database — that energy reaches you as high-frequency buzz. The Fortuner's {{impact:fortuner}}/100 is better on paper, but it pays it back as low-frequency lumbar-resonance jolts. The composite number is a starting point. The components — and the WBV character — tell the story."},
    ]
  },
  {
    id:"civic-vs-corolla",
    ...
    category:"COMPARISON",
    readTime:"7 min read",
    summary:"Both are locally assembled. Both are called Japanese sedans. One lets {{felt:civic_11pk}}% of a pothole hit reach your spine. The other lets {{felt:corolla_12pk}}% through. Here's exactly why.",
    cars:["Civic 11th Gen","Corolla Altis X"],
    content:[
      {type:"lead",text:"The Corolla and Civic are Pakistan's two most compared cars. Every review says something like 'the Corolla has a softer ride, the Civic is more sporty.' The correct comparison is: one of these cars lets {{felt:civic_11pk}}% of a pothole hit reach your spine; the other lets {{felt:corolla_12pk}}% through. The difference is entirely architectural."},
      {type:"h2",text:"The one fact that explains everything"},
      {type:"p",text:"Pakistan's Honda Civic 11th generation has a fully independent multilink rear suspension. The current Pakistan-assembled Toyota Corolla (the Altis X — IMC has not launched the global 12th-generation E210 sedan here) uses a torsion beam rear suspension. These are fundamentally different engineering architectures, and the Corolla's is the cheaper, older one."},
      {type:"p",text:"The global E210 Corolla in Japan, Europe, and Australia has had a multilink rear since 2018. Pakistan still gets the previous-generation torsion beam version — a cost-and-platform decision that means buyers pay for a 2025 car but receive 2014-era rear suspension architecture."},
  ...
  },
  {
    ...
    category:"ANALYSIS",
    readTime:"5 min read",
    summary:"The Alto JDM and Alto PK are the same car — same platform, same engine, same body. They score {{gap:alto_jdm,alto_pk}} points apart on CarComfortScore. Here's exactly what's different.",
    cars:["Alto (PK)","Alto (Japan Import)"],
    content:[
      {type:"lead",text:"Pakistan's domestically assembled cars are built from knock-down kits. The body, suspension geometry, and engine are largely the same as the Japan Import version. So why does the JDM Alto score {{crcs:alto_jdm}} vs the Pakistan Alto's {{crcs:alto_pk}}? Even a small gap involves three decisions made specifically to hit a price point."},
      ...
      {type:"p",text:"The most commercially significant JDM vs local gap in Pakistan is the Corolla. The JDM Toyota Corolla E210 has multilink independent rear suspension. The Pakistan-assembled Corolla — still the E170-platform Altis X facelift, because IMC hasn't launched the E210 sedan locally — uses a torsion beam. The JDM Corolla scores {{impact:corolla_12jdm}} on Impact Isolation. The PK Corolla scores {{impact:corolla_12pk}}. The {{impact-gap:corolla_12jdm,corolla_12pk}}-point gap is largely this one component choice."},
  ...
  },
  {
    ...
    category:"EXPLAINER",
    readTime:"5 min read",
    summary:"Corolla. City. Yaris. Cultus. Alto. Elantra. Most of Pakistan's best-selling cars use torsion beam rear suspension. Here's what that means and what it costs you.",
    cars:["Toyota Corolla Altis X","Honda City 6th Gen"],
    content:[
      {type:"lead",text:"Look at Pakistan's best-selling passenger cars. Most of them use torsion beam rear suspension. This is not coincidence — it's an industry-wide cost decision. Understanding what a torsion beam is and why it affects your comfort is the single most useful thing a Pakistani car buyer can know."},
      ...
      {type:"p",text:"Toyota Corolla (Pakistan-assembled Altis X): torsion beam — and IMC hasn't launched the global E210 sedan locally, so PK buyers are still on a 2014-era rear axle. Toyota Yaris: same story. Honda City (all generations in Pakistan): torsion beam. Hyundai Elantra (AD): torsion beam. Suzuki Cultus: torsion beam. Suzuki Alto (Pakistan): torsion beam, stiffened version. (The Pakistan-assembled Suzuki WagonR is one of the few exceptions — it uses a slightly better trailing-arm rear that local assembly kept by accident when Suzuki Japan moved to torsion beam.)"},
